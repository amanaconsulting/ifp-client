...
namespace AMANA.IFP
{
    ...
    {
        internal static void ToMessageBox(this Exception ex)
        {
            MessageBox.Show($"{ex.Message}:\n{ex.StackTrace}");
        }

        internal static ComboBox SetSelectedItemDataBinding(this ComboBox comboBox, object dataSource, string dataMember,
        ...
        internal static CheckBox SetCheckedDataBinding(this CheckBox checkBox, object dataSource, string dataMember,
            DataSourceUpdateMode updateMode = DataSourceUpdateMode.OnPropertyChanged)
        {
        ...
        internal static Control SetTextDataBinding(this Control control, object dataSource, string dataMember,
            DataSourceUpdateMode updateMode = DataSourceUpdateMode.OnPropertyChanged)
        {
        ...
        internal static Control SetEnabledDataBinding(this Control control, object dataSource, string dataMember,
            DataSourceUpdateMode updateMode = DataSourceUpdateMode.OnPropertyChanged)
        {
        ...
        internal static Control SetVisibleDataBinding(this Control control, object dataSource, string dataMember,
            DataSourceUpdateMode updateMode = DataSourceUpdateMode.OnPropertyChanged)
        {
        ...
        internal static Control SetDataBinding(this Control control, string propertyName, object dataSource,
